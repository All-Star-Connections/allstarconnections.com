...
"Check"
      ...
      <Section>
        <Container type="sm">
          <div className="lg:max-w-3xl mx-auto space-y-8">
            ...
            <p>
              {allCompany.name} is committed to ensuring digital accessibility
            ...
            <p>
              ...
              {allCompany.name} is partially conformant with WCAG 2.1 level AA.
