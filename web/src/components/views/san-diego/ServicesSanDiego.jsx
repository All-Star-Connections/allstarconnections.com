...
const ServicesSanDiego = () => {
  const data = useStaticQuery(graphql`
    query ServicesSanDiegoQ {
      imgServiceOne: file(
        relativePath: {
          eq: "assets/images/san-diego-ca/san-diego-ca-industries-medical-device-biotechnology-job-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
      ...
      imgServiceTwo: file(
        relativePath: {
          eq: "assets/images/san-diego-ca/san-diego-ca-industries-information-technology-job-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
          gatsbyImageData(quality: 90, layout: FULL_WIDTH, placeholder: BLURRED)
      ...
      imgServiceThree: file(
        relativePath: {
          eq: "assets/images/san-diego-ca/san-diego-ca-industries-manufacturing-job-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
          gatsbyImageData(quality: 90, layout: FULL_WIDTH, placeholder: BLURRED)
      ...
      imgServiceFour: file(
        relativePath: {
          eq: "assets/images/san-diego-ca/san-diego-ca-industries-civil-structural-engineering-job-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
          gatsbyImageData(quality: 90, layout: FULL_WIDTH, placeholder: BLURRED)
  ...
  const features = [
    {
      ...
      image: imgServiceOne,
      alt: 'All-Star Connections is a medical device recruiting agency and a biotechnology recruiting agency in San Diego, CA.',
    ...
    },
    {
      ...
      image: imgServiceTwo,
      alt: 'All-Star Connections is an information technology (IT) recruiting agency in San Diego, CA.',
    ...
    },
    {
      ...
      alt: 'All-Star Connections is a civil & structural engineering recruiting agency in San Diego, CA.',
    ...
    <div className="relative bg-gray-200 py-16 sm:py-24 lg:py-32">
      ...
      >
        ...
        <h2 className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
          San Diego Job Recruiting Industries
        </h2>
...
export default ServicesSanDiego;
