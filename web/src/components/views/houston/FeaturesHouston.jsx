...
const FeaturesHouston = () => {
  ...
  const data = useStaticQuery(graphql`
    query FeaturesHoustonQ {
      ...
      imgMeeting: file(
        relativePath: {
          eq: "assets/images/houston-tx/houston-tx-interview-engineering-job-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
      ...
      imgPlacement: file(
        relativePath: {
          eq: "assets/images/houston-tx/houston-tx-placement-sustainability-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
          gatsbyImageData(quality: 90, layout: FULL_WIDTH, placeholder: BLURRED)
      ...
      imgEngineer: file(
        relativePath: {
          eq: "assets/images/houston-tx/houston-tx-engineering-programmer-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
          gatsbyImageData(quality: 90, layout: FULL_WIDTH, placeholder: BLURRED)
        ...
        <Grid classes="lg:grid-cols-2 gap-x-12 gap-y-14 lg:gap-y-32">
            ...
            <div className="text-lg text-gray-500 max-w-prose mx-auto lg:max-w-none space-y-10">
              <div className="space-y-6">
                <h2 className="text-3xl text-primary font-extrabold tracking-wide capitalize">
                  We Provide Top Talent For Houston Companies To Hire On-Demand
                </h2>
                <p>
          ...
          <Col classes="order-4 lg:order-4">
            <div className="text-lg text-gray-500 max-w-prose mx-auto lg:max-w-none space-y-10">
              <div className="space-y-6">
                <h2 className="text-3xl text-primary font-extrabold tracking-wide capitalize">
                  Placement Sustainability is Our #1 Goal For Houston Companies
                </h2>
          ...
          <Col classes="order-6 lg:order-5">
            <div className="text-lg text-gray-500 max-w-prose mx-auto lg:max-w-none space-y-10">
              <div className="space-y-6">
                <h2 className="text-3xl text-primary font-extrabold tracking-wide capitalize">
                  Houston's Engineering Industry Is Our Primary Focus
                </h2>
                <ul className="fa-ul">
                  <li>
                    <span className="fa-li">
...
export default FeaturesHouston;
